...
export function Trapezoid() {
    return (
        <div className="flex items-center">
            <div className="border-0 clip-trapezoid bg-[#006847] min-h-[24] h-[10vw] sm:h-[5vw] w-[10vw] " >
            </div>
            <div className="ml-[-1] border-0 bg-[#006847] min-h-[24] h-[10vw] sm:h-[5vw] w-full" ></div>
