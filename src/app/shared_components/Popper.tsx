...
export function SimplePopper() {
	...
	return (<div>
		...
		<Popper placement='bottom' className="z-1000" id={id} open={open} anchorEl={anchorEl}>
			...
			<Link href="https://play.google.com/store/apps/details?id=com.zentavos.mobile" className="h-[8vw] w-[25vw] md:h-[5vw] md:w-[17vw] relative block">
				<Image className="!relative" src="/Google_Play_Store_badge_EN (1).svg" fill={true} alt="Google Play" sizes="(max-width: 768px) 25vw, 17vw"></Image>
				</Link>
			<Link href="https://apps.apple.com/us/app/zentavos/id6742329325" className="h-[8vw] w-[25vw] md:h-[5vw] md:w-[17vw] relative block">
				<Image className="!relative" src="/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg" fill={true} alt="App Store" sizes="(max-width: 768px) 25vw, 17vw"></Image>
				</Link>
			</div>
		</Popper>
	</div>)
...
export function DownloadPopperSide() {
	...
	return (<div>
		...
		<Popper placement='bottom' className="z-1000" id={id} open={open} anchorEl={anchorEl}>
			...
			<Link href="https://play.google.com/store/apps/details?id=com.zentavos.mobile" className="h-[10vw] w-[27.2vw] relative block">
				<Image className="!relative" src="/Google_Play_Store_badge_EN (1).svg" fill={true} alt="Google Play" sizes="27.2vw"></Image>
			</Link>
			<Link href="https://apps.apple.com/us/app/zentavos/id6742329325" className="h-[10vw] w-[27.2vw] relative block">
				<Image className="!relative" src="/Download_on_the_App_Store_Badge_US-UK_RGB_blk_092917.svg" fill={true} alt="App Store" sizes="27.2vw"></Image>
				</Link>
			</div>
		</Popper>
	</div>)
