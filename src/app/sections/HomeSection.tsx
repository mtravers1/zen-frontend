  ...
  return (
    <div className="relative w-full">
      <Element id="home" name="home" className="element">
        {/* Hero Section 1 */}
        <div className="relative aspect-[16/9] w-full justify-center flex flex-col md:flex-row items-center">
          ...
          <div className="relative z-10 w-full md:w-1/2 flex justify-start items-center p-4 md:p-8 pb-0">
            <div className="max-w-2xl flex flex-col items-start text-left">
              <h1 className="font-bold text-white text-2xl sm:text-5xl md:text-6xl leading-tight mb-6 md:mb-8">
          ...
          <div className="relative z-10 w-full md:w-1/2 flex justify-start md:justify-end items-center p-4 md:p-8">
            <div className="flex flex-col gap-2 w-full max-w-[250px]">
              <Link
                ...
                className="relative hover:opacity-90 transition-opacity h-8 md:h-16 w-28 md:w-auto"
              >
                <Image
              ...
              <Link
                ...
                className="relative hover:opacity-90 transition-opacity h-10 md:h-16 w-28 md:w-auto"
              >
                <Image
