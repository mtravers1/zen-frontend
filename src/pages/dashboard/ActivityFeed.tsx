...
const ActivityFeedPage = () => {
  ...
  const filteredActivities = mockActivities.filter((activity) => {
    ...
    const matchesSearch = activity.account.toLowerCase().includes(searchValue.toLowerCase()) ||
      activity.item.toLowerCase().includes(searchValue.toLowerCase());
  ...
  return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <DashboardPageHeader
            title="Activity Feed"
            description="Track all actions and events across accounts"
