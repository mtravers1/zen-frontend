		...
		<Box>
			<Box sx={{ display: "flex", alignItems: "center", gap: 1.5, mb: 3 }}>
				<Box sx={{ p: 0.75, borderRadius: 1.5, bgcolor: "primary.main", display: "flex" }}>
					<DynamicFormIcon sx={{ color: "white", fontSize: 20 }} />
				</Box>
				<Box>
					<Typography variant="h6" fontWeight={700}>Templates</Typography>
					<Typography variant="body2" color="text.secondary">Reusable document and communication templates</Typography>
				</Box>
			</Box>
			<Card variant="outlined" sx={{ borderRadius: 2 }}>
				<CardContent sx={{ display: "flex", flexDirection: "column", alignItems: "center", py: 8 }}>
					...
					<Typography variant="body2" color="text.secondary">
						Templates are under development. Check back soon.
					</Typography>
				</CardContent>
			</Card>
		</Box>
