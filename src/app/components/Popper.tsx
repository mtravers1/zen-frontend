...
export function SimplePopper() {
    ...
    return (<div>
        ...
        <Popper className="z-1000 opacity-100" id={id} open={open} anchorEl={anchorEl}>
            <div className="flex gap-[1vw] m-[1vw]">
                <div className="h-[5vw]">
                    <Image className="!relative" src="/GetItOnGooglePlay_Badge_Web_color_English.png" fill={true} alt="" ></Image>
                </div>
                <div className="h-[5vw]">
